...
execute store result storage quack:internal entity_rotation[0] float 0.00005 run scoreboard players get euler.roll quack
data modify entity @s Rotation set from storage quack:internal entity_rotation
execute positioned 0.0 0.0 0.0 rotated as @s run tp @s ^ ^ ^1
data modify storage quack:internal entity_position set from entity @s Pos
execute store result score #internal.euler.cos_roll quack run data get storage quack:internal entity_position[2] 32768
execute store result score #internal.euler.sin_roll quack run data get storage quack:internal entity_position[0] -32768
