...
function recess:raycast/start { \
    steps: 10, \
    step_size: 0.1, \
    on_step: "recess:infection/item/flamethrower/flame_step", \
    on_block_hit: "recess:infection/item/flamethrower/flame_block_hit", \
    on_entity_hit: "recess:infection/item/flamethrower/flame_entity_hit", \
