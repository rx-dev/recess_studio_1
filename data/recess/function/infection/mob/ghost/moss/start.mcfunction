...
execute facing entity @p[distance=..32,gamemode=!creative,gamemode=!spectator] eyes positioned 0.0 0.0 0.0 summon marker run function recess:infection/mob/ghost/moss/motion_vector with storage infection:temp dist
...
execute if entity @p[distance=..32,gamemode=!creative,gamemode=!spectator] as @n[type=item,tag=infection.ghost_moss_item_init] at @s run function recess:infection/mob/ghost/moss/init
