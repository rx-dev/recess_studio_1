...
data merge entity @s {CustomName: {text: 'Pale Ghost'}, CustomNameVisible: false, Invulnerable:1b, Silent:1b, Tags: ["infection.mob", "infection.ghost_brain"], active_effects: [{duration: -1, show_icon: 0b, amplifier: 1b, id: "minecraft:invisibility", show_particles: 0b}]}
